        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form method="POST" action="modifierrec.php?idd=<?php echo $row['id_reclamation']; ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="reclamationn" autofocus onblur=""  id="reclamationn" class="form-control" value="<?php echo $row['reclamationf']; ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="reponse" autofocus onblur=""  id="reponse" class="form-control" value="<?php echo $row['reponse']; ?>" readonly>
