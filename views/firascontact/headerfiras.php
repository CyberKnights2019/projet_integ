...
include_once "D:/programs/wamp64/www/Projet_integre1/core/commandeC.php";
$pa=new PanierC();
$count=$pa->Count();
            ...
            <div class="container">
                <ul class="site-menu js-clone-nav d-none d-md-block">
                    ...
                    <li class="has-children">
                        <a href="../firascontact/formulaire_reclamation.php">Reclamation</a>
                        <ul class="dropdown">
                            <li><a href="../firascontact/formulaire_reclamation.php">Ajouter Reclamation</a></li>
                            <li><a href="../firascontact/afficherreclamation.php">Afficher mes reclamations</a></li>
                            <li><a href="../avisfront/formulaire_avis.php">ajouter votre avis</a></li>
                            <li><a href="../avisfront/afficheravis.php">afficher votre avis</a></li>
                        </ul></li>
                    <li><a href="../../gentelella-master/production/AdminNada/login.php">Espace Admin</a></li>
