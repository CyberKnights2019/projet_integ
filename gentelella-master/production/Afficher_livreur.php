          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Gestion de livreurs<small></small></h2>
                 ...
                 $listeLivreurs=$livreur1C->afficherLivreur();
                      ...
                      foreach($listeLivreurs as $row){
                        ...
                        <tr>
                                                    ...
                                                    <td><div class="zoom"><img style="width:80px;height:80px;border-radius: 50%;" src="showimage.php?id=<?PHP echo $row['CIN']; ?>" ></div></td>
                                                    ...
                                                    <td><a href="Modifier_Livreur.php?cin=<?PHP echo $row['CIN']; ?> " class="btn btn-info">
                                                  Modifier</a></td>
                                                    </tr>
                                                    <?PHP
                                                  }
