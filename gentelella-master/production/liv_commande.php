          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Commandes non livrées<small></small></h2>
...
<br>
              ...
              foreach ($liste as $c ) {
                ...
                ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $c['prix_t']; ?> </td>
                          <td><?php echo $c['etat']; ?></td>
                          <td><?php echo $c['livraison']; ?></td>
                          <td><?php echo $c['Zone']; ?></td>
                          <td><?php echo $c['Adresse']; ?></td>

                          <td><?php echo $c['payment']; ?></td>
                          <form method="POST" action="ajoutbon.php">
                          <td><select id="heard" class="form-control" name="s" >
                  ...
                  foreach($listeLivreurs as $row){
                    ...
                    ?>
                      ...
                      <?php } ?>
                          ...
                          <td>
                          <input type="submit" name="attribuer" value="attribuer" class="btn btn-info">
                          <input type="hidden" value="<?PHP echo $row['CIN']; ?>" name="cinL">
                          <input type="hidden" value="<?PHP echo $c['ID_C']; ?>" name="idcL">
                          </form>
                          </td>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Bons de livraison<small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
              ...
              foreach ($liste as $c ) {
                ...
                ?>
                        ...
                        <tr>
                          <td><?php echo $c['cin']; ?></td>
                          <td><?php echo $c['id_c']; ?></td>
                          <td><?php echo $c['date_remise']; ?> </td>
                          <td><?php echo $c['zone']; ?></td>
                          <td><?php echo $c['adresse']; ?></td>
                          <td><?php echo $c['nom']." ".$c['prenom']; ?></td>
<form method="POST" action="Updatebon.php">
                          <td><select id="heard" class="form-control" name="liste">
