              ...
              foreach ($liste as $c ) {
                ...
                ?>
                    ...
                    <form method="POST" action="commande.php">
                            ID Commande <br> <input type="text" name="IDC"   placeholder="" > <br> <br>
                            Etat <br> <input type="text" name="etat"   placeholder="" > <br> <br>
