...
$query = "SELECT id_categorie, count(*) as number FROM produit GROUP BY id_categorie";
    ...
    <script type="text/javascript">
        ...
        function drawChart()
        {
            var data = google.visualization.arrayToDataTable([
                ...
                {
                    echo "['".$row["id_categorie"]."', ".$row["number"]."],";
                }
                ?>
            ]);
            var options = {
                 title: '******* statistique des produits selon la categorie',
                //is3D:true,
                pieHole: 0.4
            };
...
<div class="container body">
    <div class="main_container">
        ...
        <div style="width:900px;">
            <h3 align="right ">statistique des produits selon la categorie</h3>
