...
$query = "SELECT marque, count(*) as number FROM produit GROUP BY marque";
...
<head>
    ...
    <script type="text/javascript">
        ...
        function drawChart()
        {
            ...
            var options = {
                title: '******* statistique des produits selon la marque',
                //is3D:true,
                pieHole: 0.4
            };
    ...
    <div class="main_container">
        ...
        <div class="col-lg-8">
            ...
            <div style="width:900px;">
                <h3 align="right ">statistique des produits selon la marque</h3>
