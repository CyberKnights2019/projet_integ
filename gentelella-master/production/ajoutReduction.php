...
//include 'reductionF.php';

if(isset($_POST['dateDebut']) and  isset($_POST['dateFin']) and isset($_POST['tauxReduction'])  and isset($_POST['idProduit']))
{
  echo "ajouter";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action ="a.php" method="POST" class="form-horizontal form-label-left" >
                        
                      
                      <span class="section">ajouter Reduction </span>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" min=0 max=100 id="tauxReduction" value="" name="tauxReduction" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                         ...
                         <input  type="submit"  name="aaa" value="Ajouter">
                        </div>
