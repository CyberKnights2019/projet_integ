                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    $listereclamation=$reclamationservice1->afficherreclamation();
                                    ...
                                    foreach ($listereclamation as  $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td><form method="POST" action="deletereclamationadmin.php">
                                            ...
                                            <td><a href="#edit<?php echo $row['id_reclamation']; ?>" data-toggle="modal" class="btn btn-success">Repondre</a> </td>
                                            <?php include('modifierreclamationadmin.php');?>
                                        </tr>
                                        <?php
                                    }
                                    ?>
