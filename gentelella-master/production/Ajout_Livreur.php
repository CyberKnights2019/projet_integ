    ...
    <div class="main_container">
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <br />
          <!-- sidebar menu -->
<?php                include_once "D:/programs/wamp64/www/Projet_integre1/gentelella-master/production/Product/headerfinal.php"
?>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form class="form-horizontal form-label-left" enctype="multipart/form-data" id="validationform" method="POST" name="formL" onsubmit="return validateForm()" action="Ajouter_Livreur.php" >


                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-3">CIN</label>
                      <div class="col-md-9 col-sm-9 col-xs-9">
                        <input name="cinL" type="text" class="form-control" required placeholder="8 numéros" onkeypress="return isNumberKey(event)" maxlength="8">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-9">
                        <input name="nomL" type="text" class="form-control" required placeholder="Nom" onkeypress="return lettersOnly(event)">
                        <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
<p id="nomX" style="color:red;padding-left:20px;display:none;"> *Nom court</p>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-9">
                        <input name="prenomL" type="text" class="form-control" required placeholder="Prénom" onkeypress="return lettersOnly(event)">
                        <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-9">
                        <input name="telL" type="text" class="form-control" required placeholder="Téléphone" onkeypress="return isNumberKey(event)">
                        <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-9">
                        <input name="mailL" type="email" class="form-control" placeholder="Adresse mail" required>
                        <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                        <p id="mailX" style="color:red;padding-left:20px;display:none;"> *Mail invalide</p>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-9">
                        <input name="adresseL" type="text" class="form-control" placeholder="Adresse" required>
                        <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                    ...
                    <input type="file" id="file" accept="image/png, image/jpeg" name="imgL" required data-role="magic-overlay" data-target="#pictureBtn" data-edit="insertImage" onchange="return fileValidation()" />
