            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Gestion du categorie<small></small></h2>
            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                foreach ($listecategorie as  $row) {
                    ...
                    <tr>
                        ...
                        <td><form method="POST" action="deleteecategorie.php">
                                <input type="submit" name="supprimer" value="Effacer" class="btn btn-danger">
                                <input type="hidden" value="<?PHP echo $row['id_cat']; ?>" name="idd">
                            </form>
                        </td>
                        <td><a href="#edit<?php echo $row['id_cat']; ?>" data-toggle="modal" class="btn btn-success">Modifier</a> </td>
<?php include('modifiercategorie.php');?>
                    </tr>
                    <?php
                }
                ?>
