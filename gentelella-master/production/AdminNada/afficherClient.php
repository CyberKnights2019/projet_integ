...
<html lang="en">
  <head>
    ...
    <link href="../../production/css/maps/style.css" rel="stylesheet">
              ...
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
				  ...
				  <form method="post" action="searchClient.php">
                    <input type="text" class="form-control" placeholder="" name="searchC">
                    <span class="input-group-btn">

                      <input class="btn btn-submit" type="submit"  value="Search" name="submitsearch">
					  <input class="btn btn-submit" type="submit"  value="Search All" name="submitAll">
...
else {	$listeClients=$client1C->rechercheClient($pC,$client1C->conn);
 }
?>
<?PHP
